...
{
  public class ProductStockStatusCss : IComputedIndexField
  {
    ...
    public object ComputeFieldValue(IIndexable indexable)
    {
      ...
      if (indexableItem != null)
      {
        if (indexableItem.Item.TemplateID.ToString() == ProductStubItem.TemplateID)
        {
          ...
          return ProductHelper.GetStockStatusCssClass(ProductHelper.GetStockStatusEnum(product.Value.ToString()));
        }
      }
      return null;
    }
