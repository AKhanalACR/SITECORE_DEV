...
$('#iw_SearchBox').on('keypress', function (e) {
    if (e.which === 13) {
        SearchPageNavigate(this);
    }
});

$('#iw_SearchLink').click(function () {
    SearchPageNavigate(this);
});

function SearchPageNavigate(e) {
    var searchInput = $(e).closest('.navbar-form-iw').find('#iw_SearchBox');
    var searchLink = $(e).closest('.navbar-form-iw').find('#iw_SearchLink');
