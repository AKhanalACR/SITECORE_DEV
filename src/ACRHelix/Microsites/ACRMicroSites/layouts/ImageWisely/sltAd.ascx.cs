...
namespace ACR.layouts.ImageWisely
{
	public partial class sltAd : System.Web.UI.UserControl
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (ItemReference.IW_Global_HomePageAds.InnerItem != null)
			{
				List<AdItem> _adItems = ItemReference.IW_Global_HomePageAds.InnerItem.Children
					.Where(i => i.TemplateID.ToString() == AdItem.TemplateId)
					.Select(i => (AdItem) i).ToList();
