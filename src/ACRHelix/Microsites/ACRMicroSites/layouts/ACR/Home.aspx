<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="ACR.layouts.ACR.Home" %>
...
<!-- End Google Tag Manager -->
    <form id="form1" runat="server">
        ...
        <div id="homeHero" runat="server">
            <div class="content">
                ...
                <div class="home-hero-text">
                    <h2>
                        <sc:FieldRenderer ID="heroHeader" runat="server" />
                    </h2>
        ...
        <div class="content" id="apply-renew">
            <sc:Placeholder runat="server" Key="modalityIcons" />
        </div>
        <sc:Placeholder runat="server" Key="homeContent" />
        <footer>
    ...
    <script src="/js/acraccreditation-main.js?v=3"></script>
