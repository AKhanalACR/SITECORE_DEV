...
{
    public partial class Hero : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            heroImage.Field = Types.Fields.InternalHeroImage;
            heroHeader.FieldName = Types.Fields.InternalHeroHeadline;
            heroContent.FieldName = Types.Fields.InternalHeroContent;

            string link = Sitecore.Context.Item[Types.Fields.InternalHeroLink];
            if (!string.IsNullOrWhiteSpace(link))
            {
                heroLink.Field = Types.Fields.InternalHeroLink;
        ...
        private void setBackgroundColorCssClass()
        {
            ...
            if (backgroundColor != null)
            {
                ...
                {
                    innerHero.Attributes.Add("class", color);
                }

            }
            innerHero.ClientIDMode = ClientIDMode.Static;
        }
    }
}