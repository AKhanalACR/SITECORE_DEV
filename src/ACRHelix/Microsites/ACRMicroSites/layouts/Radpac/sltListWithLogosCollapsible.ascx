<%@ Control Language="C#" AutoEventWireup="true" Inherits="ACR.layouts.Radpac.sltListWithLogosCollapsible" Codebehind="sltListWithLogosCollapsible.ascx.cs" %>
<%@ Register TagPrefix="acr" TagName="image" Src="~/controls/Common/SitecoreImage.ascx" %><script src="/js/Radpac/expand-collapse.js" type="text/javascript">
		</script>
