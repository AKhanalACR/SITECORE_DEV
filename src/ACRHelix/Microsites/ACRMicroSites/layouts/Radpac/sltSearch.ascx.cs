...
namespace ACR.layouts.Radpac
{
    public partial class sltSearch : SearchPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //try
            //{
            //    googleSearch = SearchUtil.BuildSearchFromRequest(Request, AcrGlobals.GSASettings["Collection.Radpac.EntireSite"], SearchMode.Date, PageQS);
            ...
            //        "Collection.Radpac.EntireSite = " + AcrGlobals.GSASettings["Collection.Radpac.EntireSite"] + "\n" +
        ...
        #region Added on 5/23/2017 Addis
        ...
        protected List<SearchResult> DisplayResults(IEnumerable<SearchResult> results)
        {
        ...
        protected void BuildPaging(IEnumerable<SearchResult> items, Literal pagingLabel, int currentPage)
        {
        ...
        public string GetFriendlyName(SearchResult item)
        {
            return item.MSLFiendlyName;
        }

        public string GetFriendlyTeaser(SearchResult item)
        {
