...
namespace ACR.controls.RLI
{
  public partial class Footer : System.Web.UI.UserControl
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      hlFacebook.NavigateUrl = LinkUtils.GetExternalUrl(settingsItem.FacebookURL.Text);
      hlTwitter.NavigateUrl = LinkUtils.GetExternalUrl(settingsItem.TwitterURL.Text);
    ...
    protected void rptFooterLinkColumns_OnItemDataBound(object sender, RepeaterItemEventArgs e)
    {
      ...
      hypHeaderLink.Text = TitleFactory.GetRLINavTitle(item.InnerItem);
    ...
    protected void rptFooterLink_OnItemDataBound(object sender, RepeaterItemEventArgs e)
    {
      ...
      hypLink.Text = TitleFactory.GetRLINavTitle(navBaseItem.InnerItem);
    }
