...
{
	public partial class PressReleaseItem : IListItem, IAcrContent
	{
		#region IListItem
		...
		public string HeaderTitle
		{
			get
			{
				...
				PressReleaseLandingPageItem landingPage = InnerItem.GetAncestor(PressReleaseLandingPageItem.TemplateId);
		...
		public string ContentSubTitle
		{
			get
			{
				...
				{
					return BasePage.ContentSubTitle;
				}
		...
		public string ContentImageUrl
		{
			get
			{
				...
				return BasePage.ContentImageUrl;
			}
		}
		...
		public string ContentBodyText
		{
			get
			{
				...
				articleContent.BodyText = BasePage.ContentBodyText;
		...
		public string ContentAdditionalInformation
		{
			get
			{
				//if we don't have footer text then return the base additional info
				if (FooterText == null || string.IsNullOrEmpty(FooterText.Text))
				{
					return BasePage.ContentAdditionalInformation;
				}

				//return our footer text
		...
		public Dictionary<string, string> CoveoAdditionalFields(string collectionName)
		{
			...
			additionalFields.Add(CoveoFields.ContentType.FieldName, "Press Release");
