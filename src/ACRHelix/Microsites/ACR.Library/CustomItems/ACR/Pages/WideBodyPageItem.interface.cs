...
{
	public partial class WideBodyPageItem : IListItemFeaturedParent, INavigationItem, IAcrContent
	{
		...
		//{
		//	return StringUtil.GetNonEmptyString(BasePage.MetaDescription.Text, BaseContent.ParentPageIntroText.Text,
		//	                                    BaseContent.ContentBodyText);
		//}
