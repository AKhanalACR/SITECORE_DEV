...
{
	public partial class CodingSourceDetailPageItem : IAcrContent
	{
		#region IAcrContent
		public string HeaderTitle
		{
			get { return GetIndexPage().BasePage.PageTitle.Text; }
		}
		...
		{
			return BasePage.HeaderTitle.Text;
		}
		...
		{
			return PublicationDate.DateTime;
		}
