...
{
public partial class CalendarItem : CustomItem
{

public static readonly string TemplateId = "{9E058A97-357B-4708-B6F0-89227B2A6416}";
...
public CalendarItem(Item innerItem) : base(innerItem)
{
...
public static implicit operator CalendarItem(Item innerItem)
{
	return innerItem != null ? new CalendarItem(innerItem) : null;
}

public static implicit operator Item(CalendarItem customItem)
{
