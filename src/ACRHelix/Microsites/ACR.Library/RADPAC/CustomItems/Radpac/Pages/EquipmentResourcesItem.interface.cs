...
{
    public partial class EquipmentResourcesItem : IPageItem, IListPage, IMeta
    {
        ...
        /* IListPage - implemented to list out Vendors*/
        public IEnumerable<IListItem> ListItems
        {
            get
            {
                ...
                {
                    return
												ItemReference.IW_EquipmentResources_Vendors.InnerItem.Axes.GetDescendants().Select(
