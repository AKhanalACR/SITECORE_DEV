...
namespace ACR.Library.Radpac.CustomItems.Radpac.Pages
{
    public partial class PledgeFormItem 
    {
        ...
        private static readonly IList<string> _RadpacCampaign = new List<string>();
        ...
        public IEnumerable<string> RadpacCampaign
        {
            get
            {
                if (_RadpacCampaign.Count == 0)
                {
                    _RadpacCampaign.Add("AAPM");
                    _RadpacCampaign.Add("AAP");
                    _RadpacCampaign.Add("ACR");
                    _RadpacCampaign.Add("AOCR");
                    _RadpacCampaign.Add("ARRS");
                    _RadpacCampaign.Add("ARRT");
                    _RadpacCampaign.Add("ASRT");
                    _RadpacCampaign.Add("AUR");
                    _RadpacCampaign.Add("CRCPD");
                    _RadpacCampaign.Add("NCRP");
										_RadpacCampaign.Add("Press");
										_RadpacCampaign.Add("RSNA");
                    _RadpacCampaign.Add("SBCT-MR");
										_RadpacCampaign.Add("Internet");
										_RadpacCampaign.Add("Scientific Publication");
										_RadpacCampaign.Add("SIR");
										_RadpacCampaign.Add("Social Media");
										_RadpacCampaign.Add("SPR");
                    _RadpacCampaign.Add("Trade Publication");
                    _RadpacCampaign.Add("Other");
                }
                return _RadpacCampaign;
            }
        }
