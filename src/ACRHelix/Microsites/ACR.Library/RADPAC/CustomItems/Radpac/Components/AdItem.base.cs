...
public partial class AdItem : CustomItem
{
    ...
    public static readonly string TemplateId = "{FDAE9F04-6A21-4325-888E-EF846CE5C06C}";
...
public CustomCheckboxField IsContributeAd
{
    get
    {
        return new CustomCheckboxField(InnerItem, InnerItem.Fields["IsContributeAd"]);
    }
}
