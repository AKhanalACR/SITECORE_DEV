...
namespace ACR.Library.ImageWisely.CustomItems.ImageWisely.Pages
{
    public partial class AboutUsItem : IPageItem, IListPage, IMeta
    {
        ...
        public IEnumerable<IListItem> ListItems
        {
            get
            {
                if(ItemReference.IW_AboutUs_ParticipatingOrganizations.InnerItem != null)
                {
                    return
												ItemReference.IW_AboutUs_ParticipatingOrganizations.InnerItem.Axes.GetDescendants().Select(
