...
namespace Sitecore.Feature.XBlog.Areas.XBlog.Items.Blog
{
    ...
    public class BlogPost : SitecoreItem, ICMSEntity
  {
        ...
        public const string BlogPostCategoryField = "blogcategory";
        public const string BlogPostAuthorField = "blogauthor";
        ...
        public const string BlogPostFeaturedImageFieldId = "{833B419C-121F-4B40-863C-99B1F6CD32F0}";
        public const string BlogPostFeaturedPositionFieldId = "{4CC04D77-9ED6-473C-9A27-C9F6BF780D2B}";
        public const string BlogPostVideoLinkFieldId = "{D571B858-0FE3-493B-8638-4A84452CB4BA}";
        public const string BlogPostFeaturedImageField = "Featured Image";
        public const string BlogPostFeaturedPositionField = "Featured Position";
        public const string BlogPostVideoLinkField = "Video Link";

        [SitecoreItemField(BlogPostFeaturedImageFieldId)]
        public virtual ImageField FeaturedImage { get; set; }

        [SitecoreItemField(BlogPostFeaturedPositionFieldId)]
        public virtual string FeaturedPosition { get; set; }

        [SitecoreItemField(BlogPostVideoLinkFieldId)]
        public virtual LinkField VideoLink { get; set; }
