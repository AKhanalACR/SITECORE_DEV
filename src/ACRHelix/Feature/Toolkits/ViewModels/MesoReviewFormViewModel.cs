...
{
  public class MesoReviewFormViewModel
  {
    private MesoReviewFormData _reviewFormData;
    private IEnumerable<SelectListItem> _reviewersList;

    public MesoReviewFormViewModel()
    {
      _reviewFormData = new MesoReviewFormData();
    ...
    public MesoReviewFormData ReviewFormData
    {
