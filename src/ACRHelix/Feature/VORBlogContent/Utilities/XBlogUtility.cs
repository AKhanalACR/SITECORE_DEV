...
namespace ACRHelix.Feature.VORBlogContent.Utilities
{
  public static class XBlogUtility
  {
    ...
    public static string ParseBlogCategories(string categoryIdList)
    {
      ...
      if (!String.IsNullOrEmpty(categoryIdList))
      {
        ...
        {
          if (Sitecore.Context.Database.Items.GetItem(categoryId)!=null)
          { 
          string CategoryUrl = "Voice-of-Radiology-Blog/category/" + Sitecore.Context.Database.Items.GetItem(categoryId).Name;
