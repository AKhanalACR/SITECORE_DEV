...
namespace ACRHelix.Feature.ImageWiselyContent.Util
{
    ...
    public class RecaptchaValidation : ValidationElement<string>
    {
        ...
        public RecaptchaValidation(ValidationDataModel validationItem) : base(validationItem)
        {
        ...
        {
            if (value == null || RecaptchaValidation.ValidateCaptcha((string)value, this.PrivateKey))
